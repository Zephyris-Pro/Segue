...
class Config:
    ...
    source: str = 'spotify'
    browser_process_names: tuple = ('chrome.exe', 'msedge.exe', 'firefox.exe', 'brave.exe', 'opera.exe', 'operagx.exe', 'vivaldi.exe', 'librewolf.exe', 'chromium.exe', 'arc.exe', 'zen.exe', 'waterfox.exe', 'floorp.exe', 'palemoon.exe', 'yandex.exe', 'whale.exe', 'thorium.exe', 'tor.exe', 'mullvadbrowser.exe', 'duckduckgo.exe')
    applemusic_process_names: tuple = ('AMPLibraryAgent.exe', 'AppleMusic.exe', 'Apple Music.exe')
    localmedia_process_names: tuple = ('vlc.exe', 'wmplayer.exe', 'Microsoft.Media.Player.exe', 'foobar2000.exe', 'MusicBee.exe', 'AIMP.exe', 'winamp.exe', 'musikcube.exe', 'Dopamine.exe', 'mpc-hc64.exe', 'mpc-hc.exe', 'mpc-be64.exe', 'mpc-be.exe')
    tidal_process_names: tuple = ('TIDAL.exe', 'TIDALPlayer.exe')
    amazonmusic_process_names: tuple = ('Amazon Music.exe',)
    ytmusic_process_names: tuple = ('YouTube Music.exe', 'YouTube Music Desktop App.exe', 'youtube-music.exe', 'ytmd.exe', 'youtube-music-desktop-app.exe')
