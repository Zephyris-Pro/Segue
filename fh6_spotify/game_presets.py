...
GAME_PRESETS: dict = {
    "forza": {
        ...
        "exe_aliases": ["forzahorizon5.exe", "forzahorizon4.exe"],
        "mode": "forza",
        "supported_devices": ["playstation", "xbox", "keyboard", "wheel"],
        "show": {
            "menu_volume": True,
            "unfocused_volume": False,
            "ducked_volume": True,
        ...
        "defaults": {
            "mode": "forza",
            "gamepad_skip_enabled": True,
            "touchpad_skip_enabled": False,
    ...
    "rocketleague": {
        ...
        "mode": "general",
        "supported_devices": ["playstation", "keyboard"],
        "show": {
            "menu_volume": False,
            "unfocused_volume": True,
            "ducked_volume": True,
            "speech_recognition": True,
            "save_cpu": True,
            "fade_length": True,
        ...
        "defaults": {
            "mode": "general",
            "general_target_process": "rocketleague.exe",
            "gamepad_skip_enabled": False,
            "touchpad_skip_enabled": True,
            "ducking_enabled": True,
            "duck_scope": "system",
            "pause_input": "tap",
        },
